...
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -expand -group bus /gmzpu_tb/zpu/zwc/zwbbus/stb_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/irq_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/int_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/rst_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/clk_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/en_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/regen_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/ready_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/irq_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/cs_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/adr_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/ack_r
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_cyc_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_stb_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_ack_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_we_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_adr_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_dat_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_dat_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_tgd_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_tgd_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_stall_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_err_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_lock_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic /gmzpu_tb/zpu/pic/wb_rty_o
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_sel_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_tga_i
add wave -noupdate -expand -group TB -expand -group zpuu -expand -group pic -radix hexadecimal /gmzpu_tb/zpu/pic/wb_tgc_i
...
WaveRestoreCursors {{Cursor 1} {12417146 ps} 0}
...
update
WaveRestoreZoom {12316528 ps} {12543472 ps}
