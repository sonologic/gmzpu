...
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/clk_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/rst_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/en_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/we_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/adr_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs -radix hexadecimal /gmzpu_tb/zpu/zwc/regs/dat_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs -radix hexadecimal /gmzpu_tb/zpu/zwc/regs/dat_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/busy_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/ready_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs -radix hexadecimal /gmzpu_tb/zpu/zwc/regs/cfg_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/err_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/rty_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs -radix hexadecimal /gmzpu_tb/zpu/zwc/regs/reg_config
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs -radix hexadecimal /gmzpu_tb/zpu/zwc/regs/reg_status
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group regs /gmzpu_tb/zpu/zwc/regs/ready_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/adr_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/ena_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/rst_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/we_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/reg_en_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/bus_en_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/radr_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/badr_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/cs_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/reg_en_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/bus_en_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/en_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/re_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/we_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/cs_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/adr
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group decode /gmzpu_tb/zpu/zwc/dec/io_adr_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/clk_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/rst_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/en_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/we_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/adr_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/dat_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/dat_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/cs_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_dat_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_dat_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_tgd_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_tgd_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_ack_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_adr_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_cyc_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_stall_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_err_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_lock_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_rty_i
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_sel_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_stb_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_tga_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_tgc_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/b_we_o
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/cyc_r
add wave -noupdate -expand -group TB -expand -group zpuu -group ZWC -group bus /gmzpu_tb/zpu/zwc/zwbbus/stb_r
...
WaveRestoreCursors {{Cursor 1} {10075478 ps} 0}
...
update
WaveRestoreZoom {9848534 ps} {10075478 ps}
